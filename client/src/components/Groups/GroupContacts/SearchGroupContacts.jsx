  ...
  <React.Fragment>
    <div className="reset-typeahead-height">
      <AsyncTypeahead
        ...
        delay={0}
      />
      <Button className="mt-4" onClick={() => submitContacts(selected, group)} bsStyle="primary">
        Add Selected
      </Button>
    </div>
  </React.Fragment>
...
export default connect(mapStateToProps, mapDispatchToProps)(SearchGroupContacts);
